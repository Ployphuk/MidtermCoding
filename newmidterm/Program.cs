...
class Program{
    ...
    static void ShowStaticMenu(){
        ...
        Program.infomationList.CurrentInfo();
...
/////////////Student///////////////
    ...
    static void CurrentstdInfo(){
        Console.WriteLine("***********************");
        Console.WriteLine(" Current Infomation");

        Program.infomationList.CurrentInfo();
    }

    static void StudentstdInfo(){
        Console.WriteLine("***********************");
        Console.WriteLine(" Current Infomation");

        Program.infomationList.StudentInfo();
    }

    static void TeacherstdInfo(){
        Console.WriteLine("***********************");
        Console.WriteLine(" Current Infomation");

        Program.infomationList.TeacherInfo();
    }
